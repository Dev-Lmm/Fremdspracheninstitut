...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="assets/css/app.css?v=26.07.22a">
    <link rel="stylesheet" href="assets/css/style.css?v=26.07.22b">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <!-- Scripts -->
    <script defer src="assets/js/index.js?v=26.07.22c"></script>
    ...
    <header class="header">
        <nav class="nav-responsive">
            ...
            <ul class="menu-bar">
                ...
                <li class="nav-menu-sections"><a href="#" class="nav-link-hover nav-style-font not-active">Acceder</a></li>
            </ul>
        </nav>
    </header>
